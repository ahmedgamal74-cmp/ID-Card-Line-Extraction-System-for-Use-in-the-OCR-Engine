# usage: python infer_seg.py --input_dir 2_IDs_derotated/ --save_dir 3_ROIs_seg/
...
def run_inference(input_dir, save_dir):
    ...
    for r in model.predict(source=[str(p) for p in imgs], conf=conf_thresh, imgsz=img_size, 
